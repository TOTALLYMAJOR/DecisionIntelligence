...
When the user explicitly requests the complete Docker runtime, use this sequence instead of the native Node baseline:
...
Read `docs/setup/DOCKER.md` and obey the Docker rule in `AGENTS.md`. Do not run a destructive volume reset, and do not interpret healthy containers as provider, corpus, canonical-knowledge, or business acceptance.
